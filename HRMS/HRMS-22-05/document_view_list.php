...
<div class="container-fluid">
      ...
      <tbody>
      <?php
      $emp_sql=$con->query("SELECT * FROM candidate_form_details where status=16 or status=18 or status=19 or status=20 or status=21 or status=22 or status=23 or status=24 ");
      $i=1;
