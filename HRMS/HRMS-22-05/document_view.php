...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <td colspan="1"><a href="recruitment/uploads/<?php echo $data['aadhar_num']; ?>" download="<?php echo $data['aadhar_num']; ?>"><?php echo $data['aadhar_num']; ?></a></td>
        </tr>
        <tr>
        <td>Pan Number:</td>
        <td colspan="4"><input type="text" class="form-control" id="pannumber" name="pannumber" value="<?php echo $data['pan_number'];?>"readonly></td>
        <td colspan="1"><a href="recruitment/uploads/<?php echo $data['pan_num']; ?>" download="<?php echo $data['pan_num']; ?>"><?php echo $data['pan_num']; ?></td>
        </tr>
        <tr>
        <td>Voter ID:</td>
        <td colspan="4"><input type="text" class="form-control" id="voternumber" name="voternumber" value="<?php echo $data['Voter_no'];?>" readonly></td>
        <td colspan="1"><a href="recruitment/uploads/<?php echo $data['voter_id']; ?>" download="<?php echo $data['voter_id']; ?>"><?php echo $data['voter_id']; ?></td>
        </tr>
        <tr>
        <td>Resume:</td>
        <td colspan="5"><a href="recruitment/uploads/<?php echo $data['resume']; ?>" download="<?php echo $data['resume']; ?>"><?php echo $data['resume']; ?></td>
        </tr>
        <!--tr>  
        <td colspan="6">
