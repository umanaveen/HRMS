...
<form role="form" action="HRMS/interview_feedback/md_submit.php" method="post" enctype="multipart/type">
...
$cnt=$cnt+1;
  ...
  <?php
  $techdeta=$con->query("select * from technical_team_details where candidate_id='$id'");
  $fetdata=$techdeta->fetch();
  $techdeta->execute();
...
$cnt=$cnt+1;
  ...
  <?php
  $techdeta1=$con->query("select * from final_technical_team_details where candidate_id='$id'");
...
<tr>
<td>CTC :*</td>
<td colspan="5"><input type="text" class="form-control" id="ctc" name="ctc" ></td>
</tr>
<tr>
<td>Feedback *:</td>
