...
include("../../user.php");
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT enquiry.id as enquiry_id,enquiry.status as enquiry_status,client_master.status as client_master_status,enquiry.mail as enquiry_mailid,enquiry.*,calls_master.*,z_department_master.*,candidate_form_details.*,client_master.*  FROM `enquiry`
	  ...
	  INNER join client_master on enquiry.Company_name=client_master.org_name
where enquiry.id='$id'"); 
...
?>
 <div class="card card-info">
              <div class="card-header">
				              ...
				              <center><h3 class="card-title"><b>Lead Details</b></h3></center>
...
$cnt=$cnt+1;
	  ...
	  <br>
				...
				<?php if ($row['enquiry_status']==2 && $row['client_master_status']==2) {
 ...
 var data = $('form').serialize();
    ...
    url:'HRMS/CRM/quote_enquiry.php',
    success:function(data)
    {
      if(data==1)
      { 
