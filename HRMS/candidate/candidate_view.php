...
<td>Designation</td>
<?php 
$fdes=$fet['final_designation'];
$des=$con->query("select * from candidate_form_details c join designation_master d on c.final_designation=d.id where d.id='$fdes'");
$dfetch=$des->fetch();
?>

<td colspan="2"><input type="text" class="form-control" id="approved_desig" name="approved_desig" value="<?php echo $dfetch['designation_name'];?>" readonly >
</td>
</tr>
<tr>
<td>CTC</td>
<td colspan="2"><input type="text" class="form-control" id="approved_ctc" name="approved_ctc" value="<?php echo $fet['approved_ctc'];?>" readonly></td>
</tr>
<tr>
<td>Joining Date</td>
<td colspan="2"><input type="text" class="form-control" id="joining_date" name="joining_date" value="<?php echo $fet['joining_date'];?>"readonly></td>
</tr>
	<?php
