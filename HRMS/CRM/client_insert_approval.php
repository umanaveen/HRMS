...
include("../../user.php");
$id=$_REQUEST['id'];
$query = $con->prepare("SELECT * FROM `client_master` where client_master.id='$id'");
$query->execute(); 
$row_fetch = $query->fetch();

if($row_fetch['approve_flag']==1)
{
...
<tr>
   <td>Customer Name </td>
   <td colspan="2"><input type="text" class="form-control" id="txt_client_name" name="txt_client_name" value="<?php echo  $row['client_name'];?>" readonly></td>
   <td>Customer  Designation</td>
   <td colspan="2"><input type="text" class="form-control" id="txt_client_desig" name="txt_client_desig" value="<?php echo  $row['designation'];?>" readonly></td>
</tr>
<?php
...
<tr>
   <td>Mobile No 1 * </td>
   <td colspan="2"><input type="text" class="form-control" id="txt_mobile1" name="txt_mobile1" value="<?php echo  $row['mobile_no1'];?>" readonly></td>
     <td>Mobile No2</td>
   <td colspan="2"><input type="text" class="form-control" id="txt_mobile2" name="txt_mobile2" value="<?php echo  $row['mobile_no2'];?>" readonly></td>
</tr>
<?php 
...
<tr>
   <td>Company Address</td>
   <td colspan="2"><input type="text" class="form-control " id="txt_address1" name="txt_address1"  value="<?php echo  $row['address1'];?>" readonly></td>
   <td colspan="2"><input type="text" class="form-control" id="txt_address2" name="txt_address2" placeholder ="Address 2" value="<?php echo  $row['address2'];?>" readonly></td>
</tr>
<?php } ?>
