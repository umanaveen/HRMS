...
$userrole=$_SESSION['userrole'];
	 ...
	 if($userrole=='ROLE-007' ){
	  ...
	  INNER JOIN candidate_form_details ON enquiry.employee=candidate_form_details.id  where enquiry.employee='$candidateid' and enquiry.status='2' or enquiry.status='3' or enquiry.status='4' or enquiry.status='5' or enquiry.status='6' or enquiry.status='7' ORDER BY enquiry.id DESC");
	 } else {
	  ...
	  where  enquiry.status='2' or enquiry.status='3' or enquiry.status='5' or enquiry.status='6' or enquiry.status='7' or enquiry.status='4' ORDER BY enquiry.id DESC");
	 }
     $cnt=1;
