...
.page-header{
 ...
 <div  class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><font size="5">Quotation List</font></h3>
...
$userrole=$_SESSION['userrole'];
	 ...
	 if($userrole=='ROLE-007' ){
	  ...
	  INNER JOIN candidate_form_details ON enquiry.employee=candidate_form_details.id  where enquiry.employee='$candidateid' and enquiry.status='8'");
...
function proposal_view(v){
	...
	$.ajax({
	type:"POST",
	url:"HRMS/BusinessProcess/quotation/add_quotation.php?id="+v,
	success:function(data)
	{
		 $("#main_content").html(data);
	}
