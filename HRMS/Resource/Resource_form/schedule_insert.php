...
else
{
 ...
 $staff_query= $con->query("select * from resource_form_detail where id='$resource_id' "); 
$staff_query->execute(); 
 ...
 $iterdate=$dt->format('M j Y g:i A');
	...
	$mail->Body = "Dear \r\n".$FULLNAME.""." ,"."\r\n\r\n<br/><br/>";	
	$mail->Body .= "Greating from Bluebase,"."\r\n\r\n<br/><br/>";	
	$mail->Body .= "We would like to inform you that your Resume is been Shortlisted for the Interview process,on ".$iterdate."\r\n\r\n<br/><br/>";
$mail->Body .= "You are requested to present for the interview at"."\r\n\r\n<br/><br/>";
$mail->Body .= "Quadsel Towers,New No 118, Anna Salai, Manikam Lane, Guindy, Chennai-600032"."\r\n\r\n<br/><br/><br/>";

  	
$mail->Body .= "Dress Code: Formals"."\r\n\r\n<br/>";	
$mail->Body .= "Bring all your documents and certificates."."\r\n\r\n<br/><br/>";	
	$mail->Body .= "  Kindly fill the online application and upload the necessary documents as requested."."\r\n\r\n<br/><br/>";
