 ...
 <div class="row">
   ...
   <div class="panel-body">
    ...
    <thead>
      ...
      <tbody>
      <?php
      $emp_sql=$con->query("SELECT * FROM assets_master");
      $i=1;
      ...
      <td><?php echo $emp_res['prefix_code']; ?></td>
	  <td>
	  <?php
	  if($emp_res['status']==1)
	  {
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/HRMS/HRMS/masters/asset_master/new_asset.php",
  ...
  function jd_edit(v)
    ...
    $.ajax({
    type:"POST",
    url:"/HRMS/HRMS/masters/asset_master/edit_asset.php?id="+v,
    success:function(data){
    $("#main_content").html(data);
    }
    })
