...
$sql=$con->query("SELECT * FROM `password_master`");
$cnt=1;
...
<td>
							...
							<button class="btn btn-success btn-sm edit btn-flat" data-id="<?php echo $products_master['password_id']; ?>" onclick="product_edit(<?php echo $products_master['password_id']; ?>)"><i class="fa fa-edit"></i> Edit</button>
</td>
...
function add()
	{
		$.ajax({
		type:"POST",
		url:"HRMS/password/password_master/password_master_add.php",
		success:function(data){
		$("#main_content").html(data);
		}
		})
