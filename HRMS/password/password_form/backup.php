...
<div class="card card-info">
    ...
    <table class="table table-bordered">
     ...
     <tr>
        ...
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter org" id="org" name="org"></td>
        </tr>
        <tr>
		
        <td> Link</td>
		
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter Link" id="Link" name="Link"></td>
        </tr>
      
		 <tr>
        <td> Username</td>
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter Username" id="Username" name="Username"></td>
        </tr>
		 <tr>
        
        <td> Password</td>
        <td colspan="5"> <input id="password-field" type="password" class="form-control" name="password" value="">
              <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span></td>
        </tr>
		 <tr>
        <td> Recovery Mail_id</td>
        <td colspan="5"><input type="email" class="form-control" placeholder="Enter Recovery Mail_id" id="R_mailid" name="R_mailid"></td>
        </tr>
		 <tr>
...
<TD>
        ...
        <td> Password</td>
        <td colspan="5"> <input id="erppassword-field" type="password" class="form-control" name="password" value="">
...
<TD>
        ...
        <td> Password</td>
        <td colspan="5"> <input id="epfpassword-field" type="password" class="form-control" name="password" value="">
...
<TD>
       ...
       <tr>
        ...
        <td> Password</td>
        <td colspan="5"> <input id="esicpassword-field" type="password" class="form-control" name="password" value="">
              <span toggle="#esicpassword-field" class="fa fa-fw fa-eye field-icon toggle-password"></span></td>
        </tr>
		  <tr>
        <td> Number</td>
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter Number" id="Number" name="Number"></td>
        </tr>
        <TR>
		  <TH>
			<INPUT type="checkbox" name="select-all" id="select-all" onclick="toggle(this);">
...
<TD>
       ...
       <tr>
        ...
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter org" id="org" name="org">
    </td>
        </tr>
	<tr>
     ...
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter bank name" id="bank" name="bank"></td>
     </tr>
   
      <tr>
     <td> Account Type</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter account type" id="acount_type" name="acount_type"></td>
     </tr>
      <tr>
     <td> Account Number</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter acc_num" id="acc_num" name="acc_num"></td>
     </tr>
      <tr>
     <td> Account holder Name</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter acc_hol_name" id="acc_hol_name" name="acc_hol_name"></td>
     </tr>
      <tr>
     <td> IFSC</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter ifsc" id="ifsc" name="ifsc"></td>
     </tr>
     <tr>
     <td> Branch</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter Branch" id="Branch" name="Branch"></td>
     </tr>
     <tr>
     <td> Accounting opening date</td>
     <td colspan="5"><input type="date" class="form-control" placeholder="Enter acc_open_date" id="acc_open_date" name="acc_open_date"></td>
     </tr>
     <tr>
     <td> Minimum Balance </td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter minimum_balance" id="minimum_balance" name="minimum_balance"></td>
     </tr>
     <TR>
		  <TH>
			<INPUT type="checkbox" name="select-all" id="select-all" onclick="toggle(this);">
...
<TD>
	...
	<tr>
     ...
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter  holder Name" id="holder_name" name="holder_name"></td>
     </tr>
      <tr>
     <td> Type of card</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter Type of card" id="Type_card" name="Type_card"></td>
     </tr>
      <tr>
     <td> Expiry Month Year</td>
     <td colspan="5"><input type="date" class="form-control" placeholder="Enter Month Year" id="month_year" name="month_year"></td>
     </tr>
     <tr>
        
        <td> CVV</td>
        <td colspan="5"> <input id="creditpassword-field" type="password" class="form-control" name="cvv" value="">
              <span toggle="#creditpassword-field" class="fa fa-fw fa-eye field-icon toggle-password"></span></td>
        </tr>
     
     <tr>
     <td> Credit Limit</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter credit limit" id="credit_limit" name="credit_limit"></td>
     </tr>
...
<TD>
    ...
    <table id="debit" class="table table-bordered" style="visibility:collapse !important;">
    <tr>
        ...
        <tr>
        <td> Card Number</td>
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter card_number" id="card_number" name="card_number"></td>
        </tr>
      
		 <tr>
        <td> card_hoder_name</td>
        <td colspan="5"><input type="text" class="form-control" placeholder="Enter card_hoder_name" id="card_hoder_name" name="card_hoder_name"></td>
        </tr>
        <tr>
     <td> Type of card</td>
     <td colspan="5"><input type="text" class="form-control" placeholder="Enter Type of card" id="Type_card" name="Type_card"></td>
     ...
     <tr>
        ...
        <td> CVV</td>
        <td colspan="5"> <input id="depassword-field" type="password" class="form-control" name="cvv" value="">
              <span toggle="#depassword-field" class="fa fa-fw fa-eye field-icon toggle-password"></span></td>
        </tr>
        <TR>
		  <TH>
			<INPUT type="checkbox" name="select-all" id="select-all" onclick="toggle(this);">
...
<TD>
			...
			<td>
			<input type="button" class="btn btn-success" id="new_row" name="new_row" onclick="append6()" value="Add">
			<input type="button" class="btn btn-danger" id="enquiry_row_remove6"  value="Remove">
			</td>
			</tr>
			</TR>
       </table>
