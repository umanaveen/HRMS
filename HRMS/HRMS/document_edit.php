...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <td colspan="5"><input type="text" class="form-control" id="email_id" name="email_id" value="<?php echo $data['email_id'];?>" 
		></td>
        </tr>
       <tr>
        ...
        <tr>
        <td>IFSC code:</td>
        <td colspan="5"><input type="text" class="form-control" id="ifsc" name="ifsc" value="<?php echo $data['ifsc'];?>" 
		></td>
        </tr>
        <tr>
	...
	<div id='loader' style='display: none;margin-left:500px;' colspan="6">
  <img src='HRMS/HRMS/Spinner-5.gif' width='100px' height='100px'>
</div>
    </div>
