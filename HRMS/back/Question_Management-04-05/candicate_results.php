...
<?php 
$sql=$con->query("select distinct candid_id from candidate_round_details ");
$cnt=1;
...
if(($row_qn['status']== '8'))  
{
echo '<span style="color:green;text-align:center;"><b>Selected for technical level</b></span>';
...
?></td>
<td><?php if ($row_qn['status'] == '20' ) : ?><button class="btn btn-success"   name="Acccept" onclick="updatestatus1(this.id,this.value)" id="1" value="<?php echo $row_qn['id'];?>">Accept</button><?php endif ?></td>
