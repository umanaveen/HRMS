...
?>
		...
		<td>
		<input type="button" class="btn btn-success" id="new_row" name="new_row" onclick="check1()" value="Add">
...
function check() 
    ...
    len=len+1; 
     $('#new_tab').append('<tr class="row_'+len+'"><td><input type="checkbox" class="chk" name="chk[]" id="chk_'+len+'" value="'+len+'"</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><input type="text" class="form-control" id="client_'+len+'"  name="client[]" value="<?php echo  $row['client'];?>"></td><td><input type="date" class="form-control" id="date_'+len+'"  name="date[]" value="<?php echo  $row['date'];?>"></td><td><input type="text" class="form-control" id="project_'+len+'"  name="project[]" value="<?php echo  $row['project'];?>"></td><td><input type="text" class="form-control" id="module_'+len+'"  name="module[]" value="<?php echo  $row['module'];?>"></td><td><input type="text" class="form-control" id="no_of_working_hours'+len+'"  name="no_of_working_hours[]" value="<?php echo  $row['no_of_working_hours'];?>"></td><td><input type="text" class="form-control" id="remarks_'+len+'"  name="remarks[]" value="<?php echo  $row['remarks'];?>"></td><td><select class="form-control" id="status_'+len+'"  name="status[]" value="<?php echo  $row['status'];?>"><option value="1">Completed</option><option value="2">Not Completed</option></select></td><td><input type="text" class="form-control" id="reason_'+len+'"  name="reason[]" value="<?php echo  $row['reason'];?>"></td></tr>'); 
    }
