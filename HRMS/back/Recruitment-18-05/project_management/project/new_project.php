...
<input type="text" class="form-control" id="project_name" name="project_name" ></td>
 ...
 <table class="table table-bordered" id="new_tab">
	<tr>
	 ...
	 <td colspan="2">
		<select class="form-control" name="department_1" id="department_1" onchange="getEmployee_data(1)">
		<!--option value="all">-- Select Department --</option-->
		<option value="all">All</option>
		<?php
		...
		<td colspan="2">
		<select class="form-control" name="employee_1" id="employee_1">
		</select> 
