...
echo "Failed to connect to MySQL: " . mysqli_connect_error();
 ...
 {
	 $sql="SELECT d.designation_name,z.dept_name,r.first_name,r.last_name,r.gender,r.mobile,r.mail,r.aadhar_no,r.degree,r.employement_status,r.position,r.year_of_pass,r.company_name,r.year_experience  FROM resource_form_detail r join designation_master d on r.position=d.id join z_department_master z on d.dep_id=z.id where r.id='$resource_id'";
