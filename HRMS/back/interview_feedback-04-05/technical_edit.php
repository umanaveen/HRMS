...
$stmt = $con->prepare("
SELECT * FROM candidate_form_details c join `technical_team_details` t on c.id=t.candidate_id join technical_team_commands m on t.id=m.technical_id join z_department_master d on c.department=d.id join designation_master dm on c.position=dm.id
WHERE c.id='$id'
"); 
...
<td colspan="5"><input type="text" class="form-control" id="ratings" name="ratings" value="" readonly></td>
</tr>
<tr>
<td>Remarks *:</td>
