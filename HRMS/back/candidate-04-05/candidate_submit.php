...
$res = $edit_id->fetch();
 $candidate_id=$res['id']; 
	if($inserts)
	{
		...
		$insert=$con->query("insert into z_user_master(department,candidate_id,user_name,password,full_name,status,email_id,user_group_code,mobile_no,gender,created_by,created_on)values('$tech_department','$candidate_id','$first_name','$password ','$full_name','1','$mail','ROLE-011','$phone','$gender','$userid','$date')");
