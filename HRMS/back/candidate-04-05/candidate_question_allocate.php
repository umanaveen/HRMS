...
if($allocate_person=='')
{	
 $ins=$con->query("insert into candidate_round_details(candid_id,round_id,qn_id,status,created_by,created_on)values('$cid','$round_type','$qn_name','$status','$userid',now())");
echo "insert into candidate_round_details(candid_id,round_id,qn_id,status,created_by,created_on)values('$cid','$round_type','$qn_name','$status','$userid',now())"; 
...
{	
 $ins=$con->query("insert into candidate_round_details(candid_id,round_id,person_id,status,created_by,created_on)values('$cid','$round_type','$allocate_person','$status','$userid',now())");
echo "insert into candidate_round_details(candid_id,round_id,person_id,status,created_by,created_on)values('$cid','$round_type','$allocate_person','$status','$userid',now())";
