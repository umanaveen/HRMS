...
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT  candidate_form_details.id,z_department_master.dept_name,candidate_form_details.position,candidate_form_details.first_name ,candidate_form_details.last_name from candidate_form_details
