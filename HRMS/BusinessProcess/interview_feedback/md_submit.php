...
$userid=$_SESSION['userid'];
 $query=$con->query("insert into md_commands(candidate_id,ctc,md_commands, md_status, status, created_by, created_on)values('$candidateid','$ctc','$remarks_md','$md_recruiter','$status','$userid','$date')");
