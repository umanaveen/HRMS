 ...
 */		
   ...
   $uploadedFile = ''; 
			...
			$upd=$con->query("update assets_form_detail set brand_name='$brand',vendor_name='$vendor',p_date='$pdate',config='$config',warranty='$Warranty',hsn_code='$hsn_code',part_no='$part_no',asset_value='$asset_value',location='$location',invoice_no='$invoice_no',invoice='$fileName',status='1',modified_by='$user_id',modified_on=now() where id='$aid' ");
			
			echo "update assets_form_detail set brand_name='$brand',vendor_name='$vendor',p_date='$pdate',config='$config',warranty='$Warranty',hsn_code='$hsn_code',part_no='$part_no',asset_value='$asset_value',location='$location',invoice_no='$invoice_no',invoice='$fileName',modified_by='$user_id',modified_on=now() where id='$aid' ";
