...
if($valid == 1){ 
  ...
  $sql=$con->query("update emp_certification set attachment='$fileNames[$i]',modified_by='$candidateid',modified_on=now() where emp_id='$candidateid' and certification_name='$certifcate'");
