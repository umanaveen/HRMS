...
<form role="form" name="" action="HRMS/Recruitment/staff_asset/staff_asset_approve_submit.php" method="post" enctype="multipart/type">
...
<script>
    ...
    $.ajax({
    type:"POST",
    url:"/HRMS/HRMS/Recruitment/staff_asset/staff_asset_approve_list.php",
