...
<div class="tab-content">
    ...
    <table class="table table-bordered">
       ...
       <tr>
        ...
        <td colspan="5"><input type="text" class="form-control" id="reason" name="reason" >
		</td>
        ...
        <tr>
        <td>Notice Period:</td>
        <td colspan="5"><input type="date" class="form-control" id="notice_period" name="notice_period"></td>
        </tr>
        <tr>
        <td>Projects to be handed over:</td>
        <td colspan="5"><input type="text" class="form-control" id="projects" name="projects" style="height: 100px;
"></td>
        </tr>
       <tr>
        <td>Confirm:</td>
	...
	function staff_update(v)
	{
		...
		var resignid=v;
		 $.ajax({
			type:"GET",
			data: "reason=" + reason +"&notice_period=" + notice_period +"&cid=" + cid +"&projects=" +projects+"&confirm="+confirm+"&remarks="+remarks+"&resignid="+resignid ,
			url:"hrms/recruitment/staff_resignation/resign_update.php",
