...
class fetch_data{
	...
	$stmt= $con->query("select * from project_management a LEFT JOIN client_master b on a.client=b.id  where a.project_id='$id'"); 
    ...
    $output ='<table width="100%" style="margin-top:15px;border: 1px solid !important;min-height: 100% !important;"  class="table table-striped">
				 <tr>               
                   <th align= "center"><u><b>SCOPE OF WORK</b></u></th>
				 </tr>
				 <tr> 
                  <td>'.$scope_of_project.'</td>
                 </tr>
				  </table>';
				  return $output;
	 }
   ...
   $stmt= $con->query("select a.project_id,b.client_name,a.Project_Name,a.scope_of_project
     from project_management a LEFT JOIN client_master b on a.client=b.id  where a.project_id='$id'"); 
	 
	 echo "select a.project_id,b.client_name,a.Project_Name,a.scope_of_project
     from project_management a LEFT JOIN client_master b on a.client=b.id  where a.project_id='$id'";
	...
	$mail->Password = 'naveen@uma@naveen';					//Sets SMTP password
   ...
   //$mail->Boby .= $message;
	/* $mail->Body    .= "<br/>".
	 "<table width='100%' border='1' style='margin-top:15px;' align='left class='table table-striped'>". 
                  "<thead><tr>".                 
                  "<th nowrap='nowrap'><u>SCOPE OF WORK</u></th>".
