...
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT enquiry.id as enquiry_id,enquiry.status as enquiry_status,enquiry.Client as enClient,client_master.id as client_master_id,enquiry.*,quotation.*,client_master.* FROM `enquiry` INNER JOIN quotation ON enquiry.id=quotation.Enquire_id INNER join client_master ON enquiry.Company_name=client_master.org_name where enquiry.id='$id' and enquiry.status='7'"); 
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
					 <input type="hidden" class="form-control" id="get_id" name="get_id" value="<?php echo $id; ?>">
					  <input type="hidden" class="form-control" id="name_id" name="name_id" value="<?php echo  $row['client_master_id'];?> " readonly>
...
// alert(data);
 ...
 $.ajax({
    ...
    url:'HRMS/Recruitment/project_management/project/project_schedule_submit.php',
