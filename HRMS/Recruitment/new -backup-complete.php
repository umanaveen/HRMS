...
?>
	...
	<?php 
	$detail1=$con->query("select * from emp_exp_detail where emp_id='$candidateid'");
...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <tr>
        <td>Name of the candidate:</td>
        <td colspan="5"><input type="text" class="form-control" id="name" name="name" value="<?php echo $data['name'];?>" ></td>
        </tr>
        <tr>
        <td>Father's Name:</td>
        ...
        <td colspan="5"><input type="text" class="form-control" id="mobile_num" name="mobile_num" value="<?php echo $data['mobile_num'];?>" ></td>
         ...
         <tr>
        <td>Emergency contact no. (Mobile/others):</td>
        <td colspan="5"><input type="text" class="form-control" id="emergency_num" name="emergency_num" value="<?php echo $data['emergency_num'];?>" ></td>
        </tr>
        <tr>
        <td>Emergency Contact Person:</td>
        <td colspan="5"><input type="text" class="form-control" id="emergency_person" name="emergency_person" value="<?php echo $data['contact_person'];?>" ></td>
        </tr>
        <tr>
        <td>Contact Person Relationship:</td>
        <td colspan="5"><input type="text" class="form-control" id="relation" name="relation" value="<?php echo $data['emergency_contact_relationship'];?>" ></td>
        </tr>
        <tr>
        <td>Category (Email ID if any):</td>
       ...
       <tr>
        <td>Account number:</td>
        <td colspan="5"><input type="text" class="form-control" id="acc_number" name="acc_number" value="<?php echo $data['acc_number'];?>" ></td>
        </tr>
        <tr>
        <td>IFSC code:</td>
        <td colspan="5"><input type="text" class="form-control" id="ifsc" name="ifsc" value="<?php echo $data['ifsc'];?>" ></td>
        </tr>
        <tr>
        <td>Account holder name:</td>
        <td colspan="5"><input type="text" class="form-control" id="acc_name" name="acc_name" value="<?php echo $data['acc_holder_name'];?>" ></td>
        </tr>
