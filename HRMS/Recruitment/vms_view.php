...
<form role="form" name="" action="" method="post" enctype="multipart/type">
	   ...
	   <div class="form-group row">
			   ...
			   <br>
			  <br>
			  <?php if($row['vms_status']==1){ ?>
			 <center><input type="button" class="btn btn-success btn-lg" id="save" name="save" onclick="change_status()" value="Approve">

<input type="button" class="btn btn-danger btn-lg"" id="save" name="save" onclick="rejected()" value="Rejected"></center>
			  <?php } ?>
              </form>
 ...
 var data = $('form').serialize();
    ...
    type:'GET',
    data:"id="+id,data,
	 url:"/HRMS/HRMS/Recruitment/reject.php",
