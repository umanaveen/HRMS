...
$sel=$con->query("select * from candidate_form_details where status=19 and id='$candidateid'");
$sfet=$sel->rowCount();
$sel1=$con->query("select * from candidate_form_details where status=21 and id='$candidateid'");
$sfet1=$sel1->rowCount();
...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <td colspan="5"><input type="text" class="form-control" id="name" name="name" value="<?php echo $data['name'];?>" readonly></td>
        </tr>
        <tr>
        <td>Father's Name:</td>
        <td colspan="5"><input type="text" class="form-control" id="fathers_name" name="fathers_name" value="<?php echo $data['fathers_name'];?>" readonly ></td>
        </tr>
        <tr>
        <td>Date of Birth:</td>
        ...
        <td colspan="5"><input type="text" class="form-control" id="communication_address" name="communication_address" value="<?php echo $data['communication_address'];?>"  readonly></td>
        </tr>
        <tr>
        <td>Permanent Address:</td>
        <td colspan="5"><input type="text" class="form-control" id="permanent_address" name="permanent_address" value="<?php echo $data['permanent_address'];?>" readonly></td>
        </tr>
        <tr>
        <td>Telephone no. (Mobile/others):</td>
        <td colspan="5"><input type="text" class="form-control" id="mobile_num" name="mobile_num" value="<?php echo $data['mobile_num'];?>" readonly></td>
        </tr>
        <tr>
...
$(document).ready(function(){
    ...
    $("#fupForm11").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/update.php',
...
$(document).ready(function(){
    ...
    $("#fupForm12").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/employee_educational_update.php',
            data: new FormData(this),
        ...
        alert('Educational qualifications form entry Successfully Completed.Then fill out the next details');
		//application();
   ...
   <div class="tab-pane" id="certification_details" >
    ...
    <tr>
     ...
     <td><input type="text" class="form-control" id="certifcatename_1" name="certifcatename[]" value="<?php echo $cert_data['certification_name'];?>" readonly></td>
      ...
      <td><input type="text" class="form-control" id="validityfrom_1" name="validityfrom[]"value="<?php echo  date('Y-m-d',strtotime($cert_data['validity_from']));?>" readonly></td>
      <td><input type="text" class="form-control" id="validityto_1" name="validityto[]"value="<?php echo  date('Y-m-d',strtotime($cert_data['validity_to']));?>" readonly></td>
...
$(document).ready(function(){
    ...
    $("#emp_education").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/employee_certificate_update.php',
            data: new FormData(this),
...
?>
    ...
    <td><input type="text" class="form-control" id="From_1" name="from[]" value="<?php echo  date('Y-m-d',strtotime($emplmnt_data['from_date'])); ?>"readonly></td>
    <td><input type="text" class="form-control" id="to_1" name="to[]" value="<?php echo  date('Y-m-d',strtotime($emplmnt_data['to_date'])); ?>"readonly></td>
...
$(document).ready(function(){
    ...
    $("#emp_educations").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/employee_employment_update.php',
            data: new FormData(this),
...
<div class="tab-content">
    ...
    <table class="table table-bordered">
        ...
        <tr>
        <td>Name of the candidate:</td>
        <td colspan="5"><input type="text" class="form-control" id="name" name="name" ></td>
        </tr>
        <tr>
        <td>Father's Name:</td>
        <td colspan="5"><input type="text" class="form-control" id="fathers_name" name="fathers_name" ></td>
        </tr>
        <tr>
        <td>Date of Birth:</td>
        ...
        <tr>
        <td>Address Communication:</td>
        <td colspan="5"><input type="text" class="form-control" id="communication_address" name="communication_address"  ></td>
        </tr>
        <tr>
        <td>Permanent Address:</td>
        <td colspan="5"><input type="text" class="form-control" id="permanent_address" name="permanent_address"  ></td>
        </tr>
        <tr>
        <td>Telephone no. (Mobile/others):</td>
        <td colspan="5"><input type="text" class="form-control" id="mobile_num" name="mobile_num"  ></td>
        </tr>
         <tr>
        <td>Emergency contact no. (Mobile/others):</td>
        <td colspan="5"><input type="text" class="form-control" id="emergency_num" name="emergency_num"  ></td>
        </tr>
        <tr>
        <td>Emergency Contact Person:</td>
        <td colspan="5"><input type="text" class="form-control" id="emergency_person" name="emergency_person" ></td>
        </tr>
        <tr>
        <td>Contact Person Relationship:</td>
        <td colspan="5"><input type="text" class="form-control" id="relation" name="relation" ></td>
        </tr>
        <tr>
        <td>Category (Email ID if any):</td>
        <td colspan="5"><input type="text" class="form-control" id="email_id" name="email_id" ></td>
        </tr>
       <tr>
        <td>Account number:</td>
        <td colspan="5"><input type="text" class="form-control" id="acc_number" name="acc_number"  ></td>
        </tr>
        <tr>
        <td>IFSC code:</td>
        <td colspan="5"><input type="text" class="form-control" id="ifsc" name="ifsc"  ></td>
        </tr>
        <tr>
        <td>Account holder name:</td>
        <td colspan="5"><input type="text" class="form-control" id="acc_name" name="acc_name"  ></td>
        </tr>
...
$(document).ready(function(){
    ...
    $("#fupForm").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/submit.php',
            data: new FormData(this),
...
$(document).ready(function(){
    ...
    $("#fupForm1").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/employee_educational_insert.php',
            data: new FormData(this),
...
$(document).ready(function(){
    ...
    $("#emp_education").on('submit', function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '/HRMS/HRMS/Recruitment/employee_certificate_insert.php',
            data: new FormData(this),
   ...
   <td><input type="button" class="btn btn-success" id="new_row" name="new_row" onclick="check2()" value="Add">
    ...
    <tr>		
    <td> Reference Name </td>
    <td ><input type="text" class="form-control" id="reference1" name="reference1"></td>
    <td ><input type="text" class="form-control" id="reference2" name="reference2"></td>
    </tr>
    <tr>		
    <td>Organization Name:</td>
    <td ><input type="text" class="form-control" id="ref_organization1" name="ref_organization1"></td>
    <td ><input type="text" class="form-control" id="ref_organization2" name="ref_organization2"></td>
    </tr>
     <tr>		
    <td>Contact Number:</td>
    <td ><input type="text" class="form-control" id="con_number1" name="con_number1"></td>
    <td ><input type="text" class="form-control" id="con_number2" name="con_number2"></td>
    </tr>
     <tr>		
    <td>Designation:</td>
    <td ><input type="text" class="form-control" id="ref_designation1" name="ref_designation1"></td>
    <td ><input type="text" class="form-control" id="ref_designation2" name="ref_designation2"></td>
    </tr>
    <tr>		
    <td>Mailid:</td>
    <td><input type="text" class="form-control" id="ref_mail1" name="ref_mail1"></td>
    <td><input type="text" class="form-control" id="ref_mail2" name="ref_mail2"></td>
    </tr>
